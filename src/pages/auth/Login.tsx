...
function Login() {
  ...
  return (
    ...
    <div className="login-page">
      ...
      <div className="floating-object object-plus">
        +
      </div>

      <div className="floating-object object-equals">
        =
      </div>

      <div className="floating-object object-five">
        5
      </div>

      <div className="floating-object object-seven">
        7
      </div>
      ...
      <div className="floating-object object-cross">
        ×
      </div>
      ...
      <main className="login-card">
        ...
        <section className="form-panel">
          ...
          <p className="form-subtitle">
            Continue your aptitude journey.
          </p>
                ...
                >
                  ...
                  {showPassword ? (
                    ...
                    >
                      ...
                      <path
                        d="M6.6 6.6C4.7 7.8 3.4 9.7 2 12c1.5 4 5 8 10 8 1 0 2-.2 2.9-.5"
                      />
          ...
          >
            ...
            <svg
              className="oauth-icon google-icon"
              viewBox="0 0 24 24"
              aria-hidden="true"
            >
