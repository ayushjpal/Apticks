  ...
  return (
    <AppLayout>
      <div className="space-y-6 sm:space-y-8 animate-entry">
        ...
        {/* TOP HERO HEADER                                   */}
        {/* ================================================= */}
        <section className="bg-white border-3 sm:border-4 border-black rounded-2xl sm:rounded-3xl shadow-[8px_8px_0_#ffd43b] p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
          ...
          <div className="flex items-center gap-2">
            <span className="bg-[#e9f6ff] border-2 border-black rounded-xl px-3.5 py-2 font-mono font-black text-xs">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
          {/* #2 Silver Podium */}
          {topThree[1] && (
            <div className="bg-white border-3 sm:border-4 border-black rounded-2xl p-5 shadow-[6px_6px_0_#38aef0] flex flex-col items-center text-center order-2 md:order-1">
              <div className="w-10 h-10 bg-[#38aef0] text-black border-2 border-black rounded-full flex items-center justify-center font-display font-black text-base shadow-[2px_2px_0_#000000] mb-3">
                #2
              </div>
              <div className="w-16 h-16 rounded-full border-3 border-black bg-[#38aef0] shadow-[2px_2px_0_#000000] overflow-hidden mb-2">
          ...
          {topThree[0] && (
            <div className="bg-[#ffd43b] border-3 sm:border-4 border-black rounded-2xl sm:rounded-3xl p-6 sm:p-7 shadow-[8px_8px_0_#000000] flex flex-col items-center text-center order-1 md:order-2 md:-translate-y-2">
              <div className="inline-flex items-center gap-1.5 bg-[#ff5b5b] text-white border-2 border-black rounded-full px-3 py-0.5 font-display font-black text-[10px] uppercase shadow-[1.5px_1.5px_0_#000000] mb-2">
                <Sparkles className="w-3.5 h-3.5" />
                SEASON LEADER
              </div>
              <div className="w-12 h-12 bg-black text-[#ffd43b] border-2 border-black rounded-full flex items-center justify-center font-display font-black text-xl shadow-[2px_2px_0_#000000] mb-3">
                #1
              </div>
              <div className="w-20 h-20 rounded-full border-3 border-black bg-white shadow-[3px_3px_0_#000000] overflow-hidden mb-2">
              ...
              <div className="mt-4 w-full py-2.5 bg-white border-2 border-black rounded-xl font-mono font-black text-base text-black shadow-[2px_2px_0_#000000]">
          ...
          {/* #3 Bronze Podium */}
          {topThree[2] && (
            <div className="bg-white border-3 sm:border-4 border-black rounded-2xl p-5 shadow-[6px_6px_0_#32e875] flex flex-col items-center text-center order-3">
              <div className="w-10 h-10 bg-[#32e875] text-black border-2 border-black rounded-full flex items-center justify-center font-display font-black text-base shadow-[2px_2px_0_#000000] mb-3">
                #3
              </div>
              <div className="w-16 h-16 rounded-full border-3 border-black bg-[#32e875] shadow-[2px_2px_0_#000000] overflow-hidden mb-2">
