  ...
  return (
    <StaffLayout>
      <div className="space-y-6 sm:space-y-8">
        {/* Welcome Banner */}
        <div className="bg-white border-2 sm:border-2 border-[#0c1d2d] p-6 sm:p-8 rounded-xl shadow-[3px_3px_0_#0c1d2d] relative overflow-hidden">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#0c1d2d] text-white rounded-full text-xs font-display font-black uppercase tracking-wider mb-3 border-2 border-[#0c1d2d]">
            ...
            <div className="flex items-center gap-3 shrink-0">
              <div className="px-4 py-3 bg-[#f8fafc] border-2 border-[#0c1d2d] rounded-xl text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
          ...
          <div className="bg-white border-2 sm:border-2 border-[#0c1d2d] p-6 rounded-xl shadow-[3px_3px_0_#0c1d2d] flex flex-col justify-between transition-transform hover:-translate-y-1">
            <div>
              <div className="flex items-center justify-between mb-4">
                <div className="w-11 h-11 bg-[#ffd43b] border-2 border-[#0c1d2d] shadow-[2px_2px_0_#0c1d2d] rounded-xl flex items-center justify-center text-black">
                  <BookOpen className="w-5 h-5" />
                </div>
                <span className="px-2.5 py-0.5 bg-black/5 text-black border border-[#0c1d2d]/20 rounded-full font-mono text-[11px] font-bold">
                  QUESTION REPO
                </span>
              </div>
              ...
              <div className="mt-5 p-3.5 bg-[#f8fafc] border-2 border-[#0c1d2d] rounded-xl">
                <div className="text-[10px] font-mono font-bold uppercase text-black/60">
            ...
            <Link
              ...
              className="mt-6 inline-flex items-center justify-between w-full px-4 py-2.5 bg-black text-white hover:bg-[#ffd43b] hover:text-black border-2 border-[#0c1d2d] rounded-xl font-display font-black text-xs uppercase tracking-wider transition-colors shadow-[2px_2px_0_#0c1d2d]"
            >
          ...
          <div className="bg-white border-2 sm:border-2 border-[#0c1d2d] p-6 rounded-xl shadow-[3px_3px_0_#0c1d2d] flex flex-col justify-between transition-transform hover:-translate-y-1">
            <div>
              <div className="flex items-center justify-between mb-4">
                <div className="w-11 h-11 bg-[#38aef0] border-2 border-[#0c1d2d] shadow-[2px_2px_0_#0c1d2d] rounded-xl flex items-center justify-center text-black">
          ...
          <div className="bg-white border-2 sm:border-2 border-[#0c1d2d] p-6 rounded-xl shadow-[3px_3px_0_#0c1d2d] flex flex-col justify-between transition-transform hover:-translate-y-1">
            <div>
              <div className="flex items-center justify-between mb-4">
                <div className="w-11 h-11 bg-[#ff7b7b] border-2 border-[#0c1d2d] shadow-[2px_2px_0_#0c1d2d] rounded-xl flex items-center justify-center text-black">
          ...
          {isAdmin && (
            <div className="bg-white border-2 sm:border-2 border-[#0c1d2d] p-6 rounded-xl shadow-[3px_3px_0_#0c1d2d] flex flex-col justify-between transition-transform hover:-translate-y-1 sm:col-span-2 lg:col-span-3">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <div className="w-9 h-9 bg-black text-[#ffd43b] border-2 border-[#0c1d2d] rounded-xl flex items-center justify-center">
                      <Users className="w-4 h-4" />
                    </div>
                    <span className="px-2.5 py-0.5 bg-[#ffd43b] text-black border border-[#0c1d2d] font-display font-black text-[10px] rounded-full uppercase">
                ...
                <div className="flex items-center gap-4 shrink-0">
                  <div className="p-3 bg-[#f8fafc] border-2 border-[#0c1d2d] rounded-xl text-center min-w-[140px]">
                    <div className="text-[10px] font-mono font-bold uppercase text-black/60">
                      REGISTERED PROFILES
                    </div>
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-5 py-3 bg-[#ffd43b] text-black hover:bg-black hover:text-white border-2 border-[#0c1d2d] shadow-[2px_2px_0_#0c1d2d] rounded-xl font-display font-black text-xs uppercase tracking-wider transition-all"
                  >
